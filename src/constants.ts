...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FANTOM]: '0x5ba4A2f5F50A596bba9191e22026Dd48fd4a400A',
  ...
  [ChainId.BSC_TESTNET]: '0xC12d8360ADb4356db95Ff11111F5Df3E084890C4',
  [ChainId.ARBITRUM]: '',
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FANTOM]: '0xFFDDfc8A5A30c36e0F0C9CC3b59b214323492d9a',
  [ChainId.FANTOM_TESTNET]: '',
  ...
  [ChainId.BSC_TESTNET]: '0x82095b7FBd779e161eDCE6dBbcE414B014275963',
  [ChainId.ARBITRUM]: '',
...
export const SUSHI_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.XDAI]: '',
  [ChainId.BSC]: '0x56dBe1eE34Ab7b54AdE7238fdA171611C3102EB9',
  [ChainId.BKC]: '0x947950BcC74888a40Ffa2593C5798F11Fc9124C4',
  [ChainId.BSC_TESTNET]: '0x3C3Ac64c66c4F2277fb793a913C0574A1DFf6864',
  [ChainId.ARBITRUM]: '',
  [ChainId.MOONBASE]: '',
  [ChainId.AVALANCHE]: '',
  [ChainId.FUJI]: '',
...
export const MASTERCHEF_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_TESTNET]: '',
  [ChainId.XDAI]: '',
  [ChainId.BSC]: '0x1E9C1cbA0532C747b58c4a684e3db4FB4D10C7A7',
  [ChainId.BKC]: '',
  [ChainId.BSC_TESTNET]: '0xeaB09fEA1c21175720d69d2451a557C00CC47E1e',
  [ChainId.ARBITRUM]: '',
  [ChainId.MOONBASE]: '',
  [ChainId.AVALANCHE]: '',
  [ChainId.FUJI]: '',
...
export const BAR_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_TESTNET]: '',
  [ChainId.XDAI]: '',
  [ChainId.BSC]: '0xa2b07c4966a801F1D623Acb642a44C78554c5593',
  [ChainId.BKC]: '',
  [ChainId.BSC_TESTNET]: '0xD57E90d51f7F4c2AddE3B6fBe8E7B52344619593',
  [ChainId.ARBITRUM]: '',
  [ChainId.MOONBASE]: '',
  [ChainId.AVALANCHE]: '',
  [ChainId.FUJI]: '',
...
export const MAKER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_TESTNET]: '',
  [ChainId.XDAI]: '',
  [ChainId.BSC]: '0x0F9CBc0C86C183f15271B720276D162d8cBfA225',
  [ChainId.BKC]: '',  
  [ChainId.BSC_TESTNET]: '0x50F6a67713a6E0cdF02a1bF1104bC9c91C1699C6',
  [ChainId.ARBITRUM]: '',
  [ChainId.MOONBASE]: '',
  [ChainId.AVALANCHE]: '',
  [ChainId.FUJI]: '',
